    ...
    actions: {
      rechercher: function rechercher() {
        ...
        this.store.queryRecord("employe", { matricule: this.get("matricule") }).then(function (employe) {
          _this.transitionToRoute(employe.get("urlDetail"), employe.get("id"));
...
define('ipi-mdd-050-web/controllers/commercials/detail', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Controller.extend({
    actions: {
      save: function save() {
        ...
        this.get("model").save().then(function () {
          _this.toast.success('Insertion effectuée !');
          _this.transitionToRoute(_this.get("model.urlDetail"), _this.get("model.id"));
        }).catch(function (error) {
          if (error.errors) {
            error.errors.forEach(function (er) {
              _this.toast.error("Erreur " + er.status + " lors de la sauvegarde, " + er.detail);
...
define('ipi-mdd-050-web/controllers/managers/detail', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Controller.extend({
    ...
    actions: {
      ...
      deleteTechniciens: function deleteTechniciens(id) {
        ...
        this.get('ajax').request("http://localhost:8080/managers/" + this.get("model.id") + "/equipe/" + id + "/remove").then(function () {
      ...
      addTechniciens: function addTechniciens(matricule) {
        ...
        this.get('ajax').request("http://localhost:8080/managers/" + this.get("model.id") + "/equipe/" + matricule + "/add").then(function (technicien) {
...
define('ipi-mdd-050-web/controllers/techniciens/detail', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Controller.extend({
    ...
    actions: {
      ...
      deleteManager: function deleteManager() {
        ...
        this.get("model").save().then(function () {
          _this3.toast.success("Suppression du manager effectuée !");
        }).catch(function (error) {
          if (error.payload) {
            _this3.toast.error(error.payload);
          }
      ...
      addManager: function addManager(matricule) {
        ...
        this.get('ajax').request("http://localhost:8080/techniciens/" + this.get("model.id") + "/manager/" + matricule + "/add").then(function (manager) {
          _this4.toast.success("Affectation du manager effectuée !");
          _this4.store.findRecord('manager', manager.id).then(function (mana) {
            _this4.set("model.manager", mana);
          });
          _this4.set("matriculeToAdd", null);
        }).catch(function (error) {
          if (error.payload) {
...
define('ipi-mdd-050-web/routes/commercials/detail', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Route.extend({
    model: function model(params) {
      return this.store.find('commercial', params.commercialId);
    }
  });
});
...
define('ipi-mdd-050-web/routes/managers/detail', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Route.extend({
    model: function model(params) {
      return this.store.find('manager', params.managerId);
    }
  });
});
define('ipi-mdd-050-web/routes/techniciens/detail', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Route.extend({
    model: function model(params) {
      return this.store.find('technicien', params.technicienId);
    }
  });
});
...
define("ipi-mdd-050-web/templates/commercials/detail", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "MET67mQf", "block": "{\"symbols\":[],\"statements\":[[6,\"h2\"],[7],[0,\"Détail du Commercial \"],[1,[20,[\"model\",\"matricule\"]],false],[8],[0,\"\\n\\n\"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"col-lg-6\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"nom\"],[7],[0,\"Nom\"],[8],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"value\",\"classNames\",\"id\"],[\"text\",[20,[\"model\",\"nom\"]],\"form-control\",\"nom\"]]],false],[0,\"\\n\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"prenom\"],[7],[0,\"Prénom\"],[8],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"value\",\"class\",\"id\"],[\"text\",[20,[\"model\",\"prenom\"]],\"form-control\",\"prenom\"]]],false],[0,\"\\n\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"matricule\"],[7],[0,\"Matricule\"],[8],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"readonly\",\"value\",\"class\",\"id\"],[\"text\",true,[20,[\"model\",\"matricule\"]],\"form-control\",\"matricule\"]]],false],[0,\"\\n\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"performance\"],[7],[0,\"Performance\"],[8],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"value\",\"class\",\"id\"],[\"number\",[20,[\"model\",\"performance\"]],\"form-control\",\"performance\"]]],false],[0,\"\\n\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"caAnnuel\"],[7],[0,\"CA Annuel\"],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"input-group\"],[7],[0,\"\\n        \"],[1,[25,\"input\",null,[[\"type\",\"value\",\"class\",\"id\"],[\"number\",[20,[\"model\",\"caAnnuel\"]],\"form-control\",\"caAnnuel\"]]],false],[0,\"\\n        \"],[6,\"span\"],[9,\"class\",\"input-group-addon\"],[7],[0,\"€\"],[8],[0,\"\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"col-lg-6\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"form-group\"],[7],[0,\"\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"nom\"],[7],[0,\"Salaire\"],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"input-group\"],[7],[0,\"\\n        \"],[1,[25,\"input\",null,[[\"type\",\"value\",\"class\",\"id\"],[\"number\",[20,[\"model\",\"salaire\"]],\"form-control\",\"salaire\"]]],false],[0,\"\\n        \"],[6,\"span\"],[9,\"class\",\"input-group-addon\"],[7],[0,\"€\"],[8],[0,\"\\n      \"],[8],[0,\"\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"primeAnnuelle\"],[7],[0,\"Prime Annuelle\"],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"input-group\"],[7],[0,\"\\n        \"],[1,[25,\"input\",null,[[\"type\",\"value\",\"class\",\"id\"],[\"number\",[20,[\"model\",\"primeAnnuelle\"]],\"form-control\",\"primeAnnuelle\"]]],false],[0,\"\\n        \"],[6,\"span\"],[9,\"class\",\"input-group-addon\"],[7],[0,\"€\"],[8],[0,\"\\n      \"],[8],[0,\"\\n\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"dateEmbauche\"],[7],[0,\"Date d'embauche\"],[8],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"value\",\"class\",\"id\"],[\"text\",[20,[\"model\",\"dateEmbaucheFormatee\"]],\"form-control\",\"dateEmbauche\"]]],false],[0,\"\\n\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"nbConges\"],[7],[0,\"Nombre de congés\"],[8],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"readonly\",\"value\",\"class\",\"id\"],[\"number\",true,[20,[\"model\",\"nbConges\"]],\"form-control\",\"nbConges\"]]],false],[0,\"\\n\\n      \"],[6,\"label\"],[9,\"class\",\"form-control-label\"],[9,\"for\",\"nombreAnneeAnciennete\"],[7],[0,\"Nombre d'années d'ancienneté\"],[8],[0,\"\\n      \"],[1,[25,\"input\",null,[[\"type\",\"readonly\",\"value\",\"class\",\"id\"],[\"number\",true,[20,[\"model\",\"nombreAnneeAnciennete\"]],\"form-control\",\"nombreAnneeAnciennete\"]]],false],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\"],[8],[0,\"\\n\"],[6,\"div\"],[9,\"class\",\"row\"],[7],[0,\"\\n  \"],[6,\"button\"],[10,\"disabled\",[26,[[25,\"if\",[[20,[\"model\",\"hasDirtyAttributes\"]],\"\",\"disabled\"],null]]]],[9,\"class\",\"btn btn-primary\"],[3,\"action\",[[19,0,[]],\"save\"]],[7],[0,\"Enregistrer\"],[8],[0,\"\\n  \"],[6,\"button\"],[9,\"class\",\"btn btn-danger\"],[3,\"action\",[[19,0,[]],\"delete\"]],[7],[0,\"Supprimer\"],[8],[0,\"\\n\"],[8],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ipi-mdd-050-web/templates/commercials/detail.hbs" } });
});
...
if (!runningTests) {
  require("ipi-mdd-050-web/app")["default"].create({"name":"ipi-mdd-050-web","version":"0.0.0+d051b311"});
}
